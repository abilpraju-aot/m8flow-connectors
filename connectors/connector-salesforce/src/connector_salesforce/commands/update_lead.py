"""Update a Lead by ID in Salesforce."""
import json
...
class UpdateLead(ConnectorCommand):
    """Update a single Lead record by record_id. fields is a JSON object of field names to values."""
    ...
    def execute(self, _config: Any, _task_data: Any) -> ConnectorProxyResponseDict:
        ...
        try:
            payload = prepare_lead_fields_for_update(fields_dict)
        ...
        path = f"Lead/{str(self.record_id).strip()}"
